...
static int parse_sig_ed448(sig_params *params, const u8 *cert, u32 off, u32 len, u32 *eaten);
static int parse_sig_ed25519(sig_params *params, const u8 *cert, u32 off, u32 len, u32 *eaten);
static int parse_sig_ecdsa(sig_params *params, const u8 *cert, u32 off, u32 len, u32 *eaten);
static int parse_sig_sm2(sig_params *params, const u8 *cert, u32 off, u32 len, u32 *eaten);
static int parse_sig_dsa(sig_params *params, const u8 *cert, u32 off, u32 len, u32 *eaten);
static int parse_sig_rsa_pkcs1_v15(sig_params *params, const u8 *cert, u32 off, u32 len, u32 *eaten);
static int parse_sig_rsa_ssa_pss(sig_params *params, const u8 *cert, u32 off, u32 len, u32 *eaten);
static int parse_sig_rsa_9796_2_pad(sig_params *params, const u8 *cert, u32 off, u32 len, u32 *eaten);
static int parse_sig_rsa_belgian(sig_params *params, const u8 *cert, u32 off, u32 len, u32 *eaten);
static int parse_sig_gost94(sig_params *params, const u8 *cert, u32 off, u32 len, u32 *eaten);
static int parse_sig_gost2001(sig_params *params, const u8 *cert, u32 off, u32 len, u32 *eaten);
static int parse_sig_gost2012_512(sig_params *params, const u8 *cert, u32 off, u32 len, u32 *eaten);
static int parse_sig_gost2012_256(sig_params *params, const u8 *cert, u32 off, u32 len, u32 *eaten);
